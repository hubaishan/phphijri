...
/**
 * convert Hijri dates to Gerigorian 
 */
class Calendar
{
	 ...
	 *        	umalqura:bool true to use Um AlQura algorithm, false to use Hijri Tabular algorithm
	 ...
	 * @return Calendar phpHijri\Calendar object with the specified settings.
	 */
	 ...
	 */
	protected function getUmalquraData($with_adj = true, $return_array = false)
	{
	 ...
	 */
	public function daysInMonth($month, $year, $umalqura = null)
	{
		if (!isset($umalqura))
		{
	 ...
	 */
	public function leapYear($year, $umalqura = null)
	{
		if (!isset($umalqura))
		{
			$umalqura = $this->umalqura;
	 ...
	 *
	 */
	protected function monthToOffest($month, $year)
	{
		$ii = $year - self::UMSTARTYEAR;
		$i = $month - 1 + 12 * $ii;
		return $i;
	...
	public function checkHijriDate($year, $month, $day)
	{
		...
		elseif ($day > $this->daysInMonth($month, $year))
		{
			return false;
		}
		else
	 ...
	 * @return string
	 */
	public static function englishSuffix($number)
	{
